                        ...
                        <div className="flex gap-4">
                            <div className="w-24 space-y-1">
                                ...
                                <select 
                                    ...
                                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:border-red-500 outline-none font-bold text-slate-700"
                                >
                            ...
                            <div className="flex-1 space-y-1">
                                <label className="text-xs font-bold text-slate-400 uppercase">
                                    {currency === 'USD' ? 'Monto Original' : 'Monto ($)'}
                                </label>
                                <input 
                                    required 
                                    type="number" 
